  ...
  <main class="main">
    <article class="portfolio">
      <article class="portfolio__text">
        ...
        На этой странице вы можете ознакомиться с подробным описанием реальных кейсов, встречающихся в нашей практике при создании сайтов и приложений для наших клиентов.
      </article>
