  ...
  <main class="main">
    <article class="article">
      ...
      <div class="article__paragraph">
        С появлением iOS 7 мир узрел новый игровой движок от Apple — SpriteKit. В свете того, что появился он недавно, об этом движке мало что написано и поэтому мы решили написать небольшой обзор наших решений.
        <br>
...
func processUserMotion(forUpdate currentTime: CFTimeInterval) {
  if let data = motionManager.accelerometerData {
    if fabs(data.acceleration.x) > 0.2 {
      ...
      <div class="article__paragraph">
        На начальном этапе также может возникнуть проблема реализации паузы. Небольшая рекомендация по данному вопросу:
        <ul>
          <li>
