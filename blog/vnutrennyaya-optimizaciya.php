    ...
    <article class="article">
      ...
      <div class="article__paragraph">
        ...
        <ul>
          ...
          <li>
            - Разместить свой сайт на как можно большем количестве сторонних площадок: справочниках, каталогах, блогах и т.д. (<a href="https://yandex.ru/yaca/" target="_blank">Яндекс.Каталог</a>, <a href="https://sprav.yandex.ru/" target="_blank">Яндекс.Справочник</a>, <a href="https://www.dmoz.org" target="_blank">DMOZ</a>)
          </li>
        </ul>
      </div>
      <div class="article__paragraph">
      ...
      <div class="article__paragraph">
        ...
        <ul>
          <li>
            - Каждая страница должна быть заточена под определенную ключевую фразу и семантически соответствовать ей;
          </li>
          <li>
      ...
      <div class="article__paragraph">
        ...
        <ul>
          <li>
            - Задаем атрибуты alt и по возможности title. Тег alt отображает информацию при выключенном отображении картинок и позволяет поисковым системам эффективней проводить поиск по изображениям;
          </li>
          <li>
      ...
      <div class="article__paragraph">
        ...
        <ul>
          ...
          <li>
            - Минифицируем все файлы CSS и JavaScript, для увеличения скорости загрузки;
          </li>
          <li>
