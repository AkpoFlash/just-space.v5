  ...
  <main class="main">
    ...
    <article class="certificates">
      <div class="certificates__text">
        ...
        Just Space - официальный партнер компании 1С-Битрикс, которая занимает первое место на российском рынке среди коммерческих CMS. Специализируемся на создании интернет-магазинов и технической поддержке высоко нагруженных систем. Наши программисты являются сертифицированными специалистами по разработке сайтов на основе 1С-Битрикс и имеют соответствующие сертификаты.
      </div>
      ...
      <div class="page-image__wrapper">
        <article class="page-image__promo">
          ...
          <div class="page-image__text">
            На страницах нашего блога мы выкладываем интересные, на наш взгляд, кейсы, стараясь рассказать о том, как мы создаем и продвигаем сайты наших клиентов, а также разрабатываем мобильные приложения. Раскрываем методики и секреты, применяемые в продвижении сайтов.
          </div>
          <div class="page-image__text">
